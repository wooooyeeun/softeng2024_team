...
def select():
    ...
    if combobox.get() == "홀짝구분":
        lbl_n = tk.Label(window, text = "<홀짝구분>", font = ("gulim", 13, "bold"))
        btn_a = tk.Button(
            master = window,
            text = "→",
            width = 6, height = 1,
        ...
        lbl_n = tk.Label(window, text = "<소수판별>", font = ("gulim", 13, "bold"))
        btn_a = tk.Button(
            master = window,
            text = "→",
            width = 6, height = 1,
        ...
        lbl_n = tk.Label(window, text = "<소수찾기>", font = ("gulim", 13, "bold"))
        btn_a = tk.Button(
            master = window,
            text = "→",
            width = 6, height = 1,
        ...
        lbl_n = tk.Label(window, text = "<팩토리얼>", font = ("gulim", 13, "bold"))
        btn_a = tk.Button(
            master = window,
            text = "→",
            width = 6, height = 1,
        ...
        lbl_n = tk.Label(window, text = "<짝수의합>", font = ("gulim", 13, "bold"))
        btn_a = tk.Button(
            master = window,
            text = "→",
            width = 6, height = 1,
        ...
        lbl_n = tk.Label(window, text = "<온도변환>", font = ("gulim", 13, "bold"))
        btn_a = tk.Button(
            master = window,
            text = "→",
            width = 6, height = 1,
        ...
        lbl_temp_f = tk.Label(window, text = "℉")
        lbl_temp_f.grid(row = 3, column = 1, sticky = "e")

    lbl_result = tk.Label(master = window, width = 20)
